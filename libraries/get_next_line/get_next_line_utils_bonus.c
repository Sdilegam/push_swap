...
/*   Updated: 2022/01/28 15:38:57 by sdi-lega         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * @param string 
 * @param chara 
 * @return int Position of "chara" in the "string" or -1 if
 ...
 * enough memory fo the two and moving them to this new memory
 * 
 * @param static_buff 
 * @param string 
